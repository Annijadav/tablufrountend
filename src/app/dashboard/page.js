...
import Birthday from "./_components/dashboard/Birthdays";
import EmployeesTypes from "./_components/dashboard/EmployeesTypes";
import GenderCount from "./_components/dashboard/GenderCount";
import HeadcountDepartment from "./_components/dashboard/HeadcountDepartment";
import Leaves from "./_components/dashboard/Leaves";
    ...
    <>
     <div className="text-sm breadcrumbs">
      ...
      <div className=" flex flex-col">
        <div className="flex-grow max-h-1/2">
          <div className="row max-h-full h-full">
